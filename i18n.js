...
const I18n = (() => {
  ...
  const messages = {
    ...
    "touch.leftShort": ["Left", "左移"],
    "touch.rightShort": ["Right", "右移"],
    "touch.difficulty": ["Difficulty", "难度"],
    "touch.start": ["Start adventure", "开始冒险"],
    "touch.again": ["Play again", "再玩一次"],
    "touch.loading": ["Getting ready…", "准备中…"],
    "touch.endless": ["Endless mode", "无尽模式"],
    "touch.hint": ["Hold an arrow to move; tap Jump, Water or Sprint. Rotate your phone and enter fullscreen for a larger view.", "按住方向键移动，点击跳跃、水弹或冲刺。横屏并进入全屏，画面更大。"],
    "touch.canvasStart": ["Tap Start adventure below", "点击下方「开始冒险」"],
    "touch.canvasAgain": ["Tap Play again below", "点击下方「再玩一次」"],
    "touch.canvasDifficulty": ["Choose your difficulty below", "在下方选择难度"],
    "touch.canvasEndless": ["Try Endless mode below", "可在下方进入无尽模式"],
    "touch.level": ["Lv. {value}", "等级 {value}"],
    "fullscreen.touchExit": ["Exit fullscreen", "退出全屏"],
    "tool.pan": ["Pan", "移动"],
    "tool.panTip": ["Pan (H)", "移动画布 (H)"],
    "editor.panHelp": ["Drag to move the map · Select Brush to paint", "拖动查看地图 · 选择画笔继续绘制"],
    "editor.touchHelp": ["Drag to paint. Select Pan to move the map; use Zoom for larger tiles.", "拖动绘制；选择「移动」拖动画布，用「缩放」放大格子。"],
    ...
    "editor.shortcuts": ["Arrow keys: move cursor · Space: paint · B: brush · E: eraser · G: fill · H: pan · Ctrl / ⌘ Z: undo", "方向键移动光标，空格绘制；B 画笔 · E 橡皮 · G 填充 · H 移动画布 · ⌘ / Ctrl Z 撤销"],
